      ...
      <div className="relative z-20 max-w-5xl mx-auto px-4 text-center">
        ...
        >
          ...
          <motion.p className="max-w-3xl text-lg sm:text-xl text-gray-600 dark:text-gray-300 mb-10 leading-relaxed">
            We build <strong className="text-brand-primary dark:text-brand-accent">AI-powered web applications</strong> that scale your business from concept to market leadership. Expert full-stack development with <strong>95% on-time delivery</strong> and 24-hour response guarantee.
          </motion.p>
