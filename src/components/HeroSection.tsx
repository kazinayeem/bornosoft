      ...
      <div className="relative z-20 max-w-5xl mx-auto px-4 text-center">
        ...
        >
          ...
          <motion.p className="max-w-2xl text-gray-600 dark:text-gray-300 mb-10 sm:text-lg">
            Bornosoft provides cutting-edge software and intelligent solutions
            to accelerate your business growth, streamline operations, and
          ...
          <motion.div className="flex flex-col sm:flex-row justify-center gap-4">
            <a
              href="#solutions"
              className="px-8 py-3 rounded-xl text-white bg-indigo-600 hover:bg-indigo-700 shadow-lg transition transform hover:scale-105"
            >
              Explore Solutions
            </a>
            <a
              href="#contact"
              className="px-8 py-3 rounded-xl text-indigo-600 dark:text-indigo-400 bg-white dark:bg-gray-800 hover:bg-indigo-50 dark:hover:bg-gray-700 shadow transition transform hover:scale-105 flex items-center justify-center gap-2"
            >
