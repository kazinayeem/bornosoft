      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            return (
              ...
              >
                <div className="relative h-full p-8 bg-white/90 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-xl border-2 border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-500 hover:shadow-2xl hover:border-transparent group-hover:bg-transparent">
                  ...
                  <div className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-br ${stat.color} blur-xl -z-10`}></div>
                  ...
                  <div className="relative text-center">
                    ...
                    >
                      <span className={`bg-gradient-to-br ${stat.color} bg-clip-text text-transparent group-hover:text-white transition-all duration-500`}>
                        {isVisible ? (
                    ...
                    {/* Decorative Line */}
                    <div className={`mt-4 mx-auto h-1 w-16 rounded-full bg-gradient-to-r ${stat.color} group-hover:bg-white group-hover:w-24 transition-all duration-500`}></div>
                  </div>
                </div>
              </motion.div>
            );
        ...
        >
          ...
          <div className="flex flex-wrap justify-center items-center gap-12">
            {["AWS", "Google Cloud", "Microsoft Azure", "MongoDB", "PostgreSQL", "Docker"].map(
              (partner, index) => (
                <motion.div
                  key={index}
